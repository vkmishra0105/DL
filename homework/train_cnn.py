...
def train(args):
    ...
    optimizer = torch.optim.SGD(model.parameters(), lr=args.learning_rate, momentum=0.9, weight_decay = weight_decay)
    loss = torch.nn.CrossEntropyLoss()

    train_data = load_data('data/valid', batch_size=batch_size)
    valid_data = load_data('data/train', batch_size=batch_size)
